...
class Wxpay_server_pub extends Common_util_pub 
{
	...
	function checkSign()
	{
		$tmpData = $this->data;
		unset($tmpData['sign']);
		if($tmpData['trade_type'] == "APP")
		{
			define("APPID", "wx18dbed3a77ba78a2");
			define("MCHID", "1308942101");
			define("KEY", "BljPER2PRb99KHrzrGa86I5KGZTEt86A");
			define("APPSECRET", "3a37408084507a5ecd89ed5a66c6be25");
			define("NOTIFY_URL", "http://s.hnsjb.cn/wechat_notify/wechat_notify.php");
		}
		else 
		{
