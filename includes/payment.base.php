...
class BasePayment extends Object
{
     ...
     *    @return    string
     */
    function _create_notify_url($out_trade_sn)
    {
        return SITE_URL . "/index.php?app=paynotify&act=notify&out_trade_sn={$out_trade_sn}";
    }
     ...
     *    @return    string
     */
    function _create_return_url($out_trade_sn)
    {
        return SITE_URL . "/index.php?app=paynotify&out_trade_sn={$out_trade_sn}";
    }
    ...
    {
        return '河南手机报 Order:' . $order_info[0]['out_trade_sn'];
    }
