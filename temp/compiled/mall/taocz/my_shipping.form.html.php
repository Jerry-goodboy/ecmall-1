...
<div class="eject_con">
    <div class="info_table_wrap">
        ...
        <ul class="info_table">
            ...
            <li>
                <h4>首重价格（1kg）:</h4>
                <p><input type="text" class="text width_normal" name="first_weight" value="<?php echo $this->_var['shipping']['first_weight']; ?>"/><b>*</b></p>
            </li>
            <li>
                <h4>续重价格（每加1kg，不足1kg按1kg计算）:</h4>
                <p><input type="text" class="text width_normal" name="step_weight" value="<?php echo $this->_var['shipping']['step_weight']; ?>"/></p>
            </li>
            <li>
                <h4>启用:</h4>
                <p>
