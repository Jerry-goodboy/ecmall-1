	...
	var ua = navigator.userAgent.toLowerCase();
        $('input[ectype="change_store_logo"]').change(function(){
        	if (ua.indexOf('firefox') > -1) {
        		...
        		var docObj = document.getElementById('logoItem');
	        	var srcnew = window.URL.createObjectURL(docObj.files[0]);
	        	$('img[ectype="store_logo"]').attr('src', srcnew);
        	} else {
        		alert('您当前使用的浏览器暂不支持图片上传');
        	}
        ...
        $('input[ectype="change_store_banner"]').change(function(){
        	...
        	if (ua.indexOf('firefox') > -1) {
        		...
        		var docObj = document.getElementById('bannerItem');
	        	var srcnew = window.URL.createObjectURL(docObj.files[0]);
	            $('img[ectype="store_banner"]').attr('src', srcnew);
        	} else {
        		alert('您当前使用的浏览器暂不支持图片上传');
        	}
            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form">
                    <div class="setup">
                        <div class="photo relative1">
                            ...
                            <b>
                            	<input ectype="change_store_logo" id="logoItem" type="file" name="file" size="1" hidefocus="true" maxlength="0" style="display:block;z-index:10; position:absolute;width: 120px; *width:0px; height: 28px; cursor: hand; cursor: pointer;  opacity:0; filter: alpha(opacity=0);">
                        ...
                        <div class="photo relative2">
                            ...
                            <b>
                                <input ectype="change_store_banner" id="bannerItem" type="file" name="file" size="1" hidefocus="true" maxlength="0" style="display:block;z-index:10; position:absolute;width: 120px; *width:0px; height: 28px; cursor: hand; cursor: pointer;  opacity:0; filter: alpha(opacity=0);">
