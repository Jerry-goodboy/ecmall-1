...
<div id="rightTop">
  ...
  <ul class="subnav">
    ...
    <li><?php if ($_GET['closed']): ?><span>待审核商品</span><?php else: ?><a class="btn1" href="index.php?app=goods&amp;closed=1">待审核商品</a><?php endif; ?></li>
    <li><a class="btn1" href="index.php?app=goods&if_credit=2">积分商品申请</a></li>
  </ul>
</div>
...
<div class="tdare">
  <table width="100%" cellspacing="0" class="dataTable">
    ...
    <tr class="tatr1">
      ...
      <td class="table-center"><span ectype="order_by" fieldname="closed">审核通过</span></td>
      <td class="table-center"><span ectype="order_by" fieldname="if_credit">积分商品</span></td>
...
?>
    ...
    <?php endif; ?>
      ...
      <td class="table-center"><?php if ($this->_var['goods']['closed']): ?><img src="<?php echo $this->res_base . "/" . 'style/images/positive_disabled.gif'; ?>" ectype="inline_edit" fieldname="closed" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="1" title="可编辑"/><?php else: ?><img src="<?php echo $this->res_base . "/" . 'style/images/positive_enabled.gif'; ?>" ectype="inline_edit" fieldname="closed" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="0" title="可编辑"/><?php endif; ?></td>
      <td class="table-center"><?php if ($this->_var['goods']['if_credit'] == 1): ?><img src="<?php echo $this->res_base . "/" . 'style/images/positive_enabled.gif'; ?>" ectype="inline_edit" fieldname="if_credit" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="1" title="可编辑"/><?php elseif ($this->_var['goods']['if_credit'] == 2): ?><img src="<?php echo $this->res_base . "/" . 'style/images/positive_disabled.gif'; ?>" ectype="inline_edit" fieldname="if_credit" fieldid="<?php echo $this->_var['goods']['goods_id']; ?>" fieldvalue="0" title="可编辑"/><?php endif; ?></td>
      <td><?php echo ($this->_var['goods']['views'] == '') ? '0' : $this->_var['goods']['views']; ?></td>
      <td><a target="_blank" href="<?php echo $this->_var['site_url']; ?>/index.php?app=goods&act=preview&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>">查看</a></td>
    </tr>
    <?php endforeach; else: ?>
