...
//        }
		...
		$this->assign('system_notice', $this->_get_system_notice($_COOKIE['member_role']));
    ...
    function register()
    {
        ...
        else
        {
            ...
            if (Conf::get('captcha_status.register') && base64_decode($_COOKIE['captcha']) != strtolower($_POST['captcha']))
            {
