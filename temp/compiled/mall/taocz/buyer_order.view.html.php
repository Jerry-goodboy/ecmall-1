...
?>
            ...
            <div class="goods">
                ...
                <br />
                                                         快递公司：<?php echo $this->_var['order']['express_name']; ?>
                <br />
                ...
                <br />
                <a href="http://m.kuaidi100.com/index_all.html?type=<?php echo $this->_var['order']['express_code']; ?>&postid=<?php echo $this->_var['order']['invoice_no']; ?>">查询</a>
                <?php endif; ?>
