...
<div class="goods-info-area">
	<h1 class="goods-name"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></h1>
        <p class="goods-info-price"><?php if ($this->_var['goods']['if_credit'] == 1): ?><strong ectype="goods_price"><?php echo $this->_var['credit']; ?></strong><span style="color: #DF0507;font-size: 12px;">积分</span><?php else: ?>&yen;<strong ectype="goods_price"><?php echo $this->_var['goods']['_specs']['0']['price']; ?></strong><?php endif; ?><?php if ($this->_var['goods']['_specs']['0']['original_price'] != 0.00): ?><span style="color: #9b9b9b;font-size: 12px;margin-left: 10px;"><?php echo $this->_var['goods']['_specs']['0']['original_price']; ?></span><?php endif; ?><?php if ($this->_var['goods']['brand']): ?><span class="goods-info-brand"><?php echo $this->_var['goods']['brand']; ?></span><?php endif; ?></p><?php if ($this->_var['goods']['if_credit'] == 1 && $this->_var['goods']['credit_mall']): ?><p class="goods_name" style="color: #DF0507;font-size: 12px;margin-top: 10px;">该商品为积分商城商品</p><?php endif; ?>
    <?php if ($this->_var['goods']['credit_mall']): ?><p class="goods_name">该商品为积分商城商品</p><?php endif; ?>
    <div class="goods-info-num">
		...
		<span class="goods-info-num-change" style="font-size: 12px;color: #9b9b9b;">
			...
			<span class="goods-left">（库存<span class="stock" ectype="goods_stock"><?php echo $this->_var['goods']['_specs']['0']['stock']; ?></span>件）</span>
		</span>
	</div>
