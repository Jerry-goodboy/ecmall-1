<div id="footer" class="w-full">
   <div class="foot-copyright">Copyright &copy; 2011-2014 <a href="http://www.hnsjb.cn">河南手机报</a> 版权所有 <?php if ($this->_var['icp_number']): ?><?php echo $this->_var['icp_number']; ?><?php endif; ?> <?php echo $this->_var['statistics_code']; ?></div>
