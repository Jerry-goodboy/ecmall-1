...
class cls_mysql
{
    ...
    function ErrorMsg($message = '', $sql = '')
    {
        ...
        else
        {
            ...
            echo '<a href="http://www.hnsjb.cn/help/faq.php?type=mysql&amp;dberrno=' . $error_no . '&amp;dberror=' . urlencode($error) . '" target="_blank">'. Lang::get('mysql_error_report') . '</a>';
        }
