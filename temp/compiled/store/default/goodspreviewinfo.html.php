...
?>
    	<div>
        	<a href="javascript:void(0)"><img src="<?php echo $this->_var['goods_image']['thumbnail']; ?>"   /></a>
       </div>
         <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>     
...
<div class="goods-info-area">
    ...
    <p class="goods-info-price"><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?></p>
    <?php if ($this->_var['goods']['credit_mall']): ?><p class="goods_name">该商品为积分商城商品</p><?php endif; ?>
    <?php if ($this->_var['goods']['credit_percent']): ?><p class="goods-name">积分抵扣该商品价格<?php echo $this->_var['goods']['credit_percent']; ?>%</p><?php endif; ?>
