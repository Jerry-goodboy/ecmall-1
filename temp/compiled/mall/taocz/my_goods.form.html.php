...
$(function(){
    ...
    $('input[name="shipping[]"]').click(function() {
    	if($(":checkbox[checked = true]").size()>0){
			$('input[name="fengshuo"]').val('true');
    	} else {
    		$('input[name="fengshuo"]').val('');
        }
     })
     if($(":checkbox[checked = true]").size()>0){
			$('input[name="fengshuo"]').val('true');
     }
    $('#cod-item').click(function() {
    	if ($('#credit-item').attr('checked')) {
    		alert('积分商品不支持货到付款选项！');
    		return false;
    	}
    })
    $('#credit-item').click(function() {
    	if ($('#cod-item').attr('checked')) {
    		alert('该商品暂不支持积分兑换！');
    		return false;
    	}
    })
    $('input[name="shipping_caculation"]').click(function() {
    	if($(".shipping_caculation").attr('checked')){
    		console.log('true;');
    		$('#weight').rules('remove');
    		$('#weight').rules('add',{  
			    required: true,  
                        ...
                        <div class="add_spec" dialog_title="编辑商品规格" ectype="dialog_contents" style="display: none">
                            ...
                            <div class="table" ectype="spec_editor">
                                <ul class="th">
                                    ...
                                    <li class="distance1">商品原价</li>
                                    <li class="distance1">库存</li>
                                    <li class="distance1">限购数量</li>
                                ...
                                <ul class="td" ectype="spec_item">
                                    ...
                                    <li><input item="limit_num" type="text" class="text width4" /></li>
                        ...
                        <div class="add_wrap">
                            <div class="assort">
                                ...
                                <p class="select" id="gcategory">
                                    ...
                                    <span class="red" style="font-family: '宋体';font-weight: bold;">*</span>
                                </p>
                            </div>
                            <div class="assort">
                                <p class="txt">本店分类: </p>
...
?>
                            ...
                            <div class="products">
                                <ul>
                                    ...
                                    <li>
                                        <h2>重量（kg）: </h2>
                                        <div class="arrange"><input name="weight" id="weight" value="<?php echo $this->_var['goods']['weight']; ?>" type="text" class="text width_short" /></div>
                                    </li>
                                    <li>
                                        <h2  ectype="no_spec">价格: </h2>
                                        <div class="arrange"  ectype="no_spec"><input name="spec_id" value="<?php echo $this->_var['goods']['_specs']['0']['spec_id']; ?>" type="hidden" /><input name="price" value="<?php echo $this->_var['goods']['_specs']['0']['price']; ?>" type="text" class="text width_short" /><span class="red">*</span></div>
                                    </li>
                                    <li>
                                        <h2  ectype="no_spec">商品原价: </h2>
                                        <div class="arrange"  ectype="no_spec"><input name="original_price" value="<?php echo $this->_var['goods']['_specs']['0']['original_price']; ?>" type="text" class="text width_short" /></div>
                                    </li>
                                    <li ectype="no_spec">
                                        <h2>库存: </h2>
                                        <div class="arrange"><input name="stock" value="<?php echo $this->_var['goods']['_specs']['0']['stock']; ?>" type="text" class="text width_short" /><span class="red">*</span></div>
                                    </li>
                                    <li ectype="no_spec">
                                        <h2>限购数量: </h2>
                                        <div class="arrange"><input name="limit_num" value="<?php echo $this->_var['goods']['_specs']['0']['limit_num']; ?>" type="text" class="text width_short" /></div>
                                    </li>
                                        ...
                                        <div class="arrange">
                                            ...
                                            <table ectype="spec_result">
                                                <tr>
                                                    ...
                                                    <th col="price">价格</th>
                                                    <th col="original_price">商品原价</th>
                                                    <th col="stock">库存</th>
                                                    <th col="limit_num">限购数量</th>
                                                    <th col="sku">货号</th>
                                                </tr>
                                    ...
                                    <li>
                                    	...
                                    	<div class="arrange">
                                    		<span class="distance">
                                    			<label><input name="postage_daofu" type="radio" value="1" <?php if ($this->_var['goods']['postage_daofu']): ?>checked="checked" <?php endif; ?>/> 是</label>
                                    			<label><input name="postage_daofu" type="radio" value="0" <?php if (! $this->_var['goods']['postage_daofu']): ?>checked="checked" <?php endif; ?> /> 否</label>
                                    		</span>
                                    	</div>
                                    </li>
                                     <li>
                                        ...
                                        <div class="arrange">
                                            <span class="distance">
                                            <?php $_from = $this->_var['shipping']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('id', 'ship');if (count($_from)):
    foreach ($_from AS $this->_var['id'] => $this->_var['ship']):
?>
                                                <label><input name="shipping[]" type="checkbox" value="<?php echo $this->_var['ship']['shipping_id']; ?>" <?php $_from = $this->_var['select_shipping']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('shipping_id', 'select');if (count($_from)):
    foreach ($_from AS $this->_var['shipping_id'] => $this->_var['select']):
?><?php if ($this->_var['ship']['shipping_id'] == $this->_var['select']['shipping_id']): ?>checked="checked"<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>/> <?php echo $this->_var['ship']['shipping_name']; ?></label>
                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            	<input name="fengshuo" type="text" value="" style="width:1px;height:1px;display:none" />
                                            </span>
                                            <span class="red">*</span>
                                        </div>
                                    </li>
                                    <li>
                                    	...
                                    	<div class="arrange">
                                    		<span class="distance">
                                    			<label><input name="shipping_caculation" type="radio" value="number" <?php if ($this->_var['goods']['shipping_caculation'] == 'number'): ?>checked="checked" <?php endif; ?> <?php if ($this->_var['goods']['shipping_caculation'] == ''): ?>checked="checked" <?php endif; ?>/> 按商品数量</label>
                                    			<label><input name="shipping_caculation" type="radio" class="shipping_caculation" value="weight" <?php if ($this->_var['goods']['shipping_caculation'] == 'weight'): ?>checked="checked" <?php endif; ?> /> 按商品重量</label>
                                    		</span>
                                    	</div>
                                    </li>
                                    <li>
                                    	...
                                    	<div class="arrange">
                                    		<span class="distance">
                                    			<label><input name="cod" type="radio" id="cod-item" value="1" <?php if ($this->_var['goods']['cod']): ?>checked="checked" <?php endif; ?>/> 支持</label>
                                    			<label><input name="cod" type="radio" value="0" <?php if (! $this->_var['goods']['cod']): ?>checked="checked" <?php endif; ?> /> 不支持</label>
                                    		</span>
                                    	</div>
                                    </li>
                                    <?php if ($this->_var['goods']['if_credit'] == 0): ?>
                                    <li>
                                    	<h2>是否申请支持积分支付：</h2>
                                    	<div class="arrange">
                                    		<span class="distance">
                                    			<label><input name="if_credit" type="radio" id="credit-item" value="2" <?php if ($this->_var['goods']['if_credit']): ?>checked="checked" <?php endif; ?>/> 是</label>
                                    			<label><input name="if_credit" type="radio" value="0" <?php if (! $this->_var['goods']['if_credit']): ?>checked="checked" <?php endif; ?> /> 否</label>
                                    		</span>
                                    	</div>
                                    </li>
                                    <!-- <li>
                                    	...
                                    	<div class="arrange">
                                    		<span class="distance">
                                    			<label><input name="credit_mall" type="radio" value="1" <?php if ($this->_var['goods']['credit_mall']): ?>checked="checked" <?php endif; ?>/> 是</label>
                                    			<label><input name="credit_mall" type="radio" value="0" <?php if (! $this->_var['goods']['credit_mall']): ?>checked="checked" <?php endif; ?> /> 否</label>
                                    		</span>
                                    	</div>
                                    	<h2>积分兑换比例：</h2>
                                    	<div class="arrange">
                                    		<span class="distance">
                                    			<label><input name="credit_percent" class="text width_normal" type="number" <?php if ($this->_var['goods']['credit_percent']): ?>value="<?php echo $this->_var['goods']['credit_percent']; ?>"<?php endif; ?> placeholder="如未申请支持积分支付则不填"/>%</label>
                                    		</span>
                                    	</div>
                                    </li> -->
                                    <?php else: ?>
                                    	<input name="if_credit" type="radio" id="credit-item" value="<?php echo $this->_var['goods']['if_credit']; ?>" checked="checked" style="display:none"/> 
                                    <?php endif; ?>
                                </ul>
                            </div>
                            <div class="clear"></div>
